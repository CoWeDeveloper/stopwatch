...
function laps(){
    ...
    var timing = document.getElementById("min").innerText + " : " + document.getElementById("sec").innerText + " : " + document.getElementById("msec").innerText  ;
    var ptext = document.createTextNode(timing);
    p.appendChild(ptext);
    var record = document.getElementById("lap");
